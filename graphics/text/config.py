...
white_graphics = {
    # Title screen of Phase 1
    "t_phase1": "Phase I: Jailbreak",
    "wibp1": "P1",
    "wibp2": "P2",
    "wibp3": "P3",
    "wibp4": "P4",
...
yellow_graphics = {
    # Title screen of Phase 2
    "t_phase2": "Phase II: Judgment",
}
...
blue_graphics = {
    ...
    "m_optttl": "OPTIONS",
    "m_skill": "Choose Skill Setting:",
    "m_epix": "<not available>",
}

green_graphics = {
    # Title screen of demo
    "t_fdemo": "Demonstration of Power",
}

red_graphics = {
    # Title for the HELP/HELP1 screen:
    "helpttl": "Helpful Things To Pick Up",
    # Title for CREDIT
    "freettl": "LibTech1",
    "m_ngame": "New Game",
    "m_option": "Options",
    ...
    "m_quitg": "Quit Game",
    "m_newg": "NEW GAME",
    "m_epid": read_bex_string(freedoom_bex,"TXT_D1ED"),
